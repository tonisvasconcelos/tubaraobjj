...
export const translations = {
  pt: {
    ...
    'schedule.filter.unit': 'Unidade',
    'schedule.filter.teacher': 'Professor',
    'schedule.filter.target': 'Público-alvo',
    'schedule.filter.all': 'Todos',
    'schedule.filter.noInstructor': 'Sem professor',
    'schedule.filter.unisex': 'Unissex',
    'schedule.filter.femaleOnlyOption': 'Apenas feminino',
  ...
  en: {
    ...
    'schedule.filter.unit': 'Location',
    'schedule.filter.teacher': 'Instructor',
    'schedule.filter.target': 'Audience',
    'schedule.filter.all': 'All',
    'schedule.filter.noInstructor': 'No instructor',
    'schedule.filter.unisex': 'Unisex',
    'schedule.filter.femaleOnlyOption': 'Women only',
  ...
  es: {
    ...
    'schedule.filter.unit': 'Sede',
    'schedule.filter.teacher': 'Profesor',
    'schedule.filter.target': 'Público',
    'schedule.filter.all': 'Todos',
    'schedule.filter.noInstructor': 'Sin profesor',
    'schedule.filter.unisex': 'Unisex',
    'schedule.filter.femaleOnlyOption': 'Solo mujeres',
